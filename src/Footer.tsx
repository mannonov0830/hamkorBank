    ...
    <footer className="bank-footer">
      <div className="footer-container">
        ...
        <div className="footer-column">
          <ul>
            <li><a href="#ofislar">Bank ofislari va bankomatlar</a></li>
            <li><a href="#kurslar">Valyutalar kursi</a></li>
            <li><a href="#kabinet">Shaxsiy kabinet</a></li>
            <li><a href="#qayta-aloqa">Qayta aloqa</a></li>
          </ul>
        </div>
        ...
        <div className="footer-column">
          <ul>
            <li><a href="#jismoniy">Jismoniy shaxslar uchun</a></li>
            <li><a href="#biznes">Biznes uchun</a></li>
            <li><a href="#moliyaviy">Moliyaviy tashkilotlarga</a></li>
            <li><a href="#haqida">Bank haqida</a></li>
          </ul>
        </div>

        <div className="footer-column">
          <ul>
            <li><a href="#matbuot">Matbuot markazi</a></li>
            <li><a href="#rekvizitlar">Rekvizitlar</a></li>
            <li><a href="#internet-bank">Internet-bank</a></li>
        ...
        <div className="footer-column mobile-bank-column">
          <div className="mobile-bank-container">
            <div className="bank-logo-wrapper">
              <div className="bank-logo"><img src={logo} alt="" /></div> 
            </div>
      ...
      <div className="footer-bottom">
        <button className="corruption-btn">Korrupsiya haqida xabar berish</button>
